...
public class IHelloWorldLocator extends org.apache.axis.client.Service implements com.test.webservice.client.IHelloWorld {
    ...
    public com.test.webservice.client.IHelloWorldPortType getIHelloWorldHttpPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.test.webservice.client.IHelloWorldHttpBindingStub _stub = new com.test.webservice.client.IHelloWorldHttpBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.test.webservice.client.IHelloWorldPortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.test.webservice.client.IHelloWorldHttpBindingStub _stub = new com.test.webservice.client.IHelloWorldHttpBindingStub(new java.net.URL(IHelloWorldHttpPort_address), this);
                _stub.setPortName(getIHelloWorldHttpPortWSDDServiceName());
                return _stub;
            }
        }
