...
public class CallCenterLocator extends org.apache.axis.client.Service implements com.test.webservice.client.CallCenter {
 ...
 */
    ...
    public com.test.webservice.client.CallCenterPort_PortType getCallCenterPort(java.net.URL portAddress) throws javax.xml.rpc.ServiceException {
        try {
            com.test.webservice.client.CallCenterPortSoapBindingStub _stub = new com.test.webservice.client.CallCenterPortSoapBindingStub(portAddress, this);
    ...
    public java.rmi.Remote getPort(Class serviceEndpointInterface) throws javax.xml.rpc.ServiceException {
        try {
            if (com.test.webservice.client.CallCenterPort_PortType.class.isAssignableFrom(serviceEndpointInterface)) {
                com.test.webservice.client.CallCenterPortSoapBindingStub _stub = new com.test.webservice.client.CallCenterPortSoapBindingStub(new java.net.URL(CallCenterPort_address), this);
                _stub.setPortName(getCallCenterPortWSDDServiceName());
                return _stub;
            }
        }
